...
const messages = {
  en: {
    ...
    adminDashboard: {
      ...
      forceRefreshAllPrices: 'Force refresh prices',
      stopAllProductUpdates: 'Stop API price updates',
      startAllProductUpdates: 'Start API price updates',
      ...
      requestsAllTimeShort: 'All-time requests',
      forceRefreshAllPricesShort: 'Refresh all prices'
    },
  ...
  lv: {
    ...
    adminDashboard: {
      ...
      forceRefreshAllPrices: 'Piespiedu cenu atjaunošana',
      stopAllProductUpdates: 'Apturēt API cenu atjaunošanu',
      startAllProductUpdates: 'Palaist API cenu atjaunošanu',
      ...
      requestsAllTimeShort: 'Kopējie pieprasījumi',
      forceRefreshAllPricesShort: 'Atjaunot visas cenas'
    },
...
messages.ru = {
  ...
  adminDashboard: {
    ...
    forceRefreshAllPrices: 'Принудительно обновить цены',
    stopAllProductUpdates: 'Остановить обновление цен через API',
    startAllProductUpdates: 'Запустить обновление цен через API',
    logs24h: 'Логи за 24ч',
    ...
    requestsAllTimeShort: 'Запросы всего',
    forceRefreshAllPricesShort: 'Обновить все цены',
  },
  adminUsers: {
