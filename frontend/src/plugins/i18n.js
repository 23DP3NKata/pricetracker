...
const messages = {
  en: {
    ...
    dashboard: {
      ...
      addAlertDesc: 'Already tracking — add another alert for this asset',
  ...
  lv: {
    ...
    dashboard: {
      ...
      addAlertDesc: 'Jau izsekots — pievienojiet vēl vienu paziņojumu šim aktīvam',
...
messages.ru = {
  ...
  dashboard: {
    ...
    addAlertDesc: 'Уже отслеживается — добавьте еще один алерт для этого актива',
