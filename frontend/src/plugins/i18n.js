...
messages.ru = {
  ...
  authRecovery: {
    ...
    verifyLimitInfo: 'Без подтверждения ваш месячный лимит - 5 проверок. После подтверждения он увеличится до 180.',
  ...
  dashboard: {
    ...
    monthlyLimit5: 'Ваш месячный лимит - 5 проверок.',
    verifyTo180: 'Подтвердите email, чтобы получить 180.',
  ...
  settings: {
    ...
    verificationInfo: 'Ваш email не подтвержден. Ваш месячный лимит - 5 проверок. После подтверждения он увеличится до 180.',
