...
const messages = {
  en: {
    ...
    about: {
      ...
      intro: 'PriceTracker helps you track crypto prices, set a target, and get notified when the price hits your level.',
      ourStory: 'Project Evolution',
      howItStarted: 'Why We Built It',
      storyPart1: 'Checking prices by hand all day gets tiring. So we built a tracker for ourselves first.',
      storyPart2: 'You set a target price and get a notification when it is reached.',
      storyPart3: 'Simple flow, less noise, faster decisions.',
      ...
      timeline2025Desc: 'Built the first working version: watchlist, basic checks, and early alerts.',
      ...
      timeline2026Desc: 'Added top-coin sync, cleaner history, and stable target notifications.',
      ...
      timelineFutureDesc: 'Planned: portfolio view, more alert conditions, and clearer weekly reports.',
      timelineFutureFeature1: 'Portfolio view',
      timelineFutureFeature2: 'Weekly reports'
    },
    ...
    auth: {
      ...
      onlyLettersNumbers: 'Only letters and numbers',
      mustIncludeLetter: 'Must contain at least one letter',
    ...
    authRecovery: {
      ...
      verifyLimitInfo: 'Without verification your monthly check limit is 0. After verifying it will be raised to 90.',
    ...
    dashboard: {
      ...
      track: 'Track',
      addAlert: 'Add Alert',
      trackDesc: 'Start tracking this asset',
      ...
      autoNotifyHint: 'Notification when price {direction} {price}',
      notifyDirectionUp: '▲ rises above',
      notifyDirectionDown: '▼ falls below',
      ...
      duplicateTracking: 'You are already tracking this asset with the same target price.',
    ...
    settings: {
      ...
      verificationInfo: 'Your email is not verified. Your monthly limit is 0 checks. After verifying it will be raised to 90.',
      verifyPromptFromTracking: 'Please verify your email to enable alerts. You can send a verification email below.',
      ...
      canChangeAfter: 'You can change your username again on {date}.',
  ...
  lv: {
    ...
    about: {
      ...
      intro: 'PriceTracker palīdz sekot kripto cenām, iestatīt mērķi un saņemt paziņojumu, kad cena to sasniedz.',
      ourStory: 'Projekta attīstība',
      howItStarted: 'Kāpēc mēs to veidojām',
      storyPart1: 'Pastāvīgi manuāli pārbaudīt cenas ir nogurdinoši. Tāpēc sākumā uztaisījām trekeri sev.',
      storyPart2: 'Tu iestati mērķa cenu un saņem paziņojumu, kad tā tiek sasniegta.',
      storyPart3: 'Vienkārša plūsma, mazāk trokšņa, ātrāki lēmumi.',
      ...
      timeline2025Desc: 'Uzbūvējām pirmo darba versiju: novērošanas saraksts, pamatpārbaudes un pirmie paziņojumi.',
      ...
      timeline2026Desc: 'Pievienojām top monētu sinhronizāciju, sakārtotāku vēsturi un stabilus mērķa paziņojumus.',
      ...
      timelineFutureDesc: 'Plānā: portfeļa skats, vairāk paziņojumu nosacījumu un skaidrāki nedēļas kopsavilkumi.',
      timelineFutureFeature1: 'Portfeļa skats',
      timelineFutureFeature2: 'Nedēļas kopsavilkumi'
    },
    ...
    auth: {
      ...
      min3Chars: 'Vismaz 3 rakstzīmes',
      onlyLettersNumbers: 'Atļauti tikai burti un cipari',
      mustIncludeLetter: 'Jābūt vismaz vienam burtam',
      emailTaken: 'Šis e-pasts jau ir izmantots',
      nameInvalid: 'Nederīgs vārds',
      passwordInvalid: 'Nederīga parole',
    ...
    authRecovery: {
      ...
      verifyLimitInfo: 'Bez apstiprināšanas tavs mēneša pārbaudes limits ir 0. Pēc apstiprināšanas tas tiks palielināts līdz 90.',
    ...
    dashboard: {
      ...
      autoNotifyHint: 'Paziņojums, kad cena {direction} {price}',
      notifyDirectionUp: '▲ pacelsies virs',
      notifyDirectionDown: '▼ noslīdēs zem',
      ...
      duplicateTracking: 'Jūs jau izseko šo aktīvu ar tādu pašu mērķa cenu.',
    ...
    productDetail: {
      ...
      pageIndicator: 'Lapa {current} no {last}',
      date: 'Datums',
      price: 'Cena',
      change: 'Izmaiņa',
    ...
    settings: {
      ...
      verificationInfo: 'Tavs e-pasts nav apstiprināts. Tavs mēneša limits ir 0 pārbaudes. Pēc apstiprināšanas tas tiks palielināts līdz 90.',
      verifyPromptFromTracking: 'Lūdzu apstiprini e-pastu, lai ieslēgtu paziņojumus. Zemāk vari nosūtīt apstiprināšanas e-pastu.',
      ...
      canChangeAfter: 'Lietotājvārdu atkal varēsi mainīt {date}.',
      ...
      required: 'Obligāti jāaizpilda',
      min3: 'Vismaz 3 rakstzīmes',
      max100: 'Maksimums 100 rakstzīmes',
      onlyLettersNumbers: 'Atļauti tikai burti un cipari',
      mustIncludeLetter: 'Jābūt vismaz vienam burtam',
      invalidEmail: 'Nederīgs e-pasts',
      emailTaken: 'Šis e-pasts jau ir aizņemts.',
      currentPasswordInvalid: 'Pašreizējā parole ir nepareiza.',
      emailSameAsCurrent: 'Jaunajam e-pastam jāatšķiras no pašreizējā.',
...
messages.ru = {
  ...
  about: {
    ...
    intro: 'PriceTracker помогает следить за криптоценами, ставить цель и получать уведомление, когда цена ее достигает.',
    ourStory: 'Развитие проекта',
    howItStarted: 'Почему мы это сделали',
    storyPart1: 'Постоянно проверять цены вручную утомляет. Поэтому сначала сделали трекер для себя.',
    storyPart2: 'Ставишь цель по цене и получаешь уведомление, когда она достигнута.',
    storyPart3: 'Простой сценарий, меньше шума, быстрее решение.',
    ...
    timeline2025Desc: 'Сделали первую рабочую версию: watchlist, базовые проверки и первые уведомления.',
    ...
    timelineFutureFeature2: 'Недельные отчеты',
  },
  auth: {
    ...messages.en.auth,
    ...
    onlyLettersNumbers: 'Только буквы и цифры',
    mustIncludeLetter: 'Должна быть хотя бы одна буква',
  ...
  authRecovery: {
    ...
    waitBefore: 'Пожалуйста, подождите',
    ...
    verifyLimitInfo: 'Без подтверждения ваш месячный лимит - 0 проверок. После подтверждения он увеличится до 90.',
  ...
  dashboard: {
    ...
    trackDesc: 'Начать отслеживать этот актив',
    ...
    autoNotifyHint: 'Уведомление, когда цена {direction} {price}',
    notifyDirectionUp: '▲ поднимется выше',
    notifyDirectionDown: '▼ опустится ниже',
    ...
    duplicateTracking: 'Вы уже отслеживаете этот товар с такой конечной ценой.',
  ...
  productDetail: {
    ...
    pageIndicator: 'Страница {current} из {last}',
    date: 'Дата',
    price: 'Цена',
    change: 'Изменение',
  ...
  settings: {
    ...
    verificationInfo: 'Ваш email не подтвержден. Ваш месячный лимит - 0 проверок. После подтверждения он увеличится до 90.',
    verifyPromptFromTracking: 'Подтвердите email, чтобы включить уведомления. Ниже можно отправить письмо подтверждения.',
    ...
    canChangeAfter: 'Имя пользователя снова можно изменить {date}.',
    ...
    invalidEmail: 'Некорректный email',
    emailTaken: 'Этот email уже используется.',
    currentPasswordInvalid: 'Текущий пароль неверный.',
    emailSameAsCurrent: 'Новый email должен отличаться от текущего.',
